...
MERGE DATASETS.DO
	...
	MERGES THE VARIOUS CLEANED FILES TOGETHER. PRECEDENCE IS ANNUAL>LIFE>EDUCATION,		// NOTE: PRECEDENCE CHANGED FROM EDUCATION>ANNUAL>LIFE
...
local j=0
foreach i in Annual Life Education{
	local j=`j'+1
...
// JCS: THIS LINE VARIES WITH THE GAP LENGTH FOR IMPUTATION SO THE RELEVANT GLOBAL MACRO IS USED
save "${dta_fld}/Merged Dataset imputation_${gap_length}m", replace
