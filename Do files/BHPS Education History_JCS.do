...
BHPS EDUCATION HISTORY.DO
	...
	UPDATES:
	* PRIORITY IS GIVEN TO EDUCATION END DATES.
	* THIS ENTAILS NOT DROPPING DATA ON THE BASIS OF START DATES (AND THEIR COMPARISON TO END OR INTERVIEW DATES).
	* THE RESULTING DATASET MAXIMISES INFORMATION ON DATE LEFT FULL TIME EDUCATION, SO THAT WHEN MERGED WITH WORK HISTORY DATA THE MAXIMUM AMOUNT OF WORK HISTORIES ARE RETAINED.
	* THE RESULTING DATASET IS DESIGNED FOR ANALYSING EDUCATION SPELLS.
...
prog_cleaneduhist						// A REVISED VERSION IS USED IN "BHPS Education History_JCS.do" AND "UKHLS Education History_JCS.do".
prog_format								// A REVISED VERSION IS USED IN "BHPS Education History_JCS.do" AND "UKHLS Education History_JCS.do".
