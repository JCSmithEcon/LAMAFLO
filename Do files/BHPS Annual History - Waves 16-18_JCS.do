...
BHPS WAVES 16-18.DO
	...
	UPDATE:	
	* A SMALL AMOUNT OF CODE FROM THE END OF "Clean Dependent Annual History_JCS.do" IS TRANSFERRED TO THE END OF THIS FILE, SO THAT FILE CAN BE USED TO CLEAN BOTH UKHLS AND BHPS DATA (UKHLS Annual History_JCS.do REQUIRES VARIANTS OF THAT CODE WITHIN A LOOP). 
	* NO OTHER SUBSTANTIVE CHANGES: THIS .DO FILE IS FUNDAMENTALLY IDENTICAL TO LW.
...
*11. Run Common Code															// THIS CODE IS MOVED HERE FROM THE END OF "Clean Dependent Annual History_JCS.do".
do "${do_fld}/Clean Work History_JCS.do"										// UNCHANGED FROM LW CODE.
